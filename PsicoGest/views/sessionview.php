<!-- En este fichero se muestran las vistas relacionadas con las sesiones -->
<?php 
...
require_once '../model/sessionmodel.php';
    ...
    class SessionView extends SessionModel {
      // esta muestra la sesión después de cualquier proceso
        function mainSessionView($patientID){
